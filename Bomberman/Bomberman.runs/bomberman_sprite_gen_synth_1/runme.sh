...
HD_PWD='C:/Users/youssef/Desktop/DigitalSystems/Bomberman/Bomberman.runs/bomberman_sprite_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bomberman_sprite_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bomberman_sprite_gen.tcl
