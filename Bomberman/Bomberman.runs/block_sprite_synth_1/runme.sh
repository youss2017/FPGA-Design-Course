...
HD_PWD='C:/Users/youssef/Desktop/DigitalSystems/Bomberman/Bomberman.runs/block_sprite_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_sprite.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_sprite.tcl
