...
HD_PWD='C:/Users/youssef/Desktop/DigitalSystems/Bomberman/Bomberman.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bomberman_game.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bomberman_game.tcl -notrace
