...
HD_PWD='C:/Users/youssef/Desktop/DigitalSystems/Bomberman/Bomberman.runs/pillar_rom_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pillar_rom_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pillar_rom_gen.tcl
