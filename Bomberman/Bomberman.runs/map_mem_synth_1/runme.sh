...
HD_PWD='C:/Users/youssef/Desktop/DigitalSystems/Bomberman/Bomberman.runs/map_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log map_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source map_mem.tcl
