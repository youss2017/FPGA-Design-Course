...
#
# Script generated by Vivado on Sun Dec 01 21:34:39 -0500 2024
...
#
# Usage        : bomb_rom.sh
#                bomb_rom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bomb_rom.sh [-reset_run]
#                bomb_rom.sh [-reset_log]
#                bomb_rom.sh [-help]
#
...
# script info
echo -e "bomb_rom.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bomb_rom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bomb_rom xil_defaultlib.bomb_rom xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bomb_rom -key {Behavioral:sim_1:Functional:bomb_rom} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bomb_rom.wdb xsim.dir libdpi.so)
...
Usage: bomb_rom.sh [-step]\n\
Usage: bomb_rom.sh [-lib_map_path]\n\
Usage: bomb_rom.sh [-reset_run]\n\
Usage: bomb_rom.sh [-reset_log]\n\
Usage: bomb_rom.sh [-keep_index]\n\
