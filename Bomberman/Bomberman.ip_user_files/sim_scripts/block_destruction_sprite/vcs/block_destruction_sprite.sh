...
#
# Script generated by Vivado on Sat Nov 30 10:51:58 -0500 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : block_destruction_sprite.sh
...
#
# Usage        : block_destruction_sprite.sh
#                block_destruction_sprite.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                block_destruction_sprite.sh [-reset_run]
#                block_destruction_sprite.sh [-reset_log]
#                block_destruction_sprite.sh [-help]
#
...
#                script (type 'block_destruction_sprite.sh -help' for more information).
#
...
# script info
echo -e "block_destruction_sprite.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./block_destruction_sprite.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.block_destruction_sprite xil_defaultlib.glbl -o block_destruction_sprite_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./block_destruction_sprite_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key block_destruction_sprite_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc block_destruction_sprite_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./block_destruction_sprite.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: block_destruction_sprite.sh [-help]\n\
Usage: block_destruction_sprite.sh [-step]\n\
Usage: block_destruction_sprite.sh [-lib_map_path]\n\
Usage: block_destruction_sprite.sh [-reset_run]\n\
Usage: block_destruction_sprite.sh [-reset_log]\n\
Usage: block_destruction_sprite.sh [-keep_index]\n\
Usage: block_destruction_sprite.sh [-noclean_files]\n\n\
