...
#
# Script generated by Vivado on Thu Nov 28 10:30:29 -0500 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : pillar_rom_gen.sh
...
#
# Usage        : pillar_rom_gen.sh
#                pillar_rom_gen.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pillar_rom_gen.sh [-reset_run]
#                pillar_rom_gen.sh [-reset_log]
#                pillar_rom_gen.sh [-help]
#
...
#                script (type 'pillar_rom_gen.sh -help' for more information).
#
...
# script info
echo -e "pillar_rom_gen.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pillar_rom_gen.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pillar_rom_gen xil_defaultlib.glbl -o pillar_rom_gen_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pillar_rom_gen_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key pillar_rom_gen_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pillar_rom_gen_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pillar_rom_gen.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pillar_rom_gen.sh [-help]\n\
Usage: pillar_rom_gen.sh [-step]\n\
Usage: pillar_rom_gen.sh [-lib_map_path]\n\
Usage: pillar_rom_gen.sh [-reset_run]\n\
Usage: pillar_rom_gen.sh [-reset_log]\n\
Usage: pillar_rom_gen.sh [-keep_index]\n\
Usage: pillar_rom_gen.sh [-noclean_files]\n\n\
