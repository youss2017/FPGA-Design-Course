...
/* 640x480
    parameter DISPLAY_WIDTH = 640, DISPLAY_HEIGHT = 480, DIV_VALUE = 4,
    H_FRONT_PORCH=16, H_SYNC = 96, H_BACK_PORCH=48,
    V_FRONT_PORCH=10, V_SYNC = 2, V_BACK_PORCH=33
*/

/* 800x600
    parameter DISPLAY_WIDTH = 800, DISPLAY_HEIGHT = 600, DIV_VALUE = 2,
...
(
    ...
    clock_divider #(.TARGET_VALUE(DIV_VALUE - 1/* count from 0 to 3 */)) pixelClockDivider(.clk(clk), .out_clk(pixelClock));
