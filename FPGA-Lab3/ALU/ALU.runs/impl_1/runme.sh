...
HD_PWD='C:/Users/youssef/Desktop/DigitalSystems/FPGA-Lab3/ALU/ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rapid_cpu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rapid_cpu.tcl -notrace
