...
HD_PWD='C:/Users/youssef/Desktop/DigitalSystems/FPGA-Lab3/ALU/ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rapid_cpu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rapid_cpu.tcl
